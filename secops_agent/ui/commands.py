...
COMMANDS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec("/theme", "Pick a colour theme (bare /theme opens a live preview picker)", "Configuration", usage="/theme [paprika|ember|sunset|amber|terracotta|rose|reef|neon|light]"),
